...
- Fixed mappings not resolving while a VPN (e.g. ExpressVPN) was connected — the proxy now applies to the VPN's tunnel interface, since macOS treats it as the primary network service

[1.25.1]: https://github.com/dfreerksen/saeng/releases/tag/v1.25.1
...
- Condition-based mocking — mock rules can now require extra header, query, or body conditions (equals/contains/regex/exists) to all match before the rule applies

[1.24.0]: https://github.com/dfreerksen/saeng/releases/tag/v1.24.0

## [1.23.0] - 2026-07-02

### Added

- Path Rewrite option per Mapping — strip or replace a path prefix before forwarding requests to the backend

### Changed

- Preload images so they load faster

[1.23.0]: https://github.com/dfreerksen/saeng/releases/tag/v1.23.0

## [1.22.0] - 2026-07-01

### Added

- "Convert to Mock" button in the request log details view — instantly create a pre-filled mock rule from a captured request/response

[1.22.0]: https://github.com/dfreerksen/saeng/releases/tag/v1.22.0

## [1.21.0] - 2026-06-30

### Added

- `.self` domain suffix option
- Query Params tab in the request log details view
- Full domain example in the Mapping modal

### Fixed

- Modals no longer close accidentally when a text selection drag ends on the backdrop

[1.21.0]: https://github.com/dfreerksen/saeng/releases/tag/v1.21.0

## [1.20.0] - 2026-06-29

### Added

- Dashboard view with stat cards, time-series charts, and per-domain group breakdowns (opt-in via Settings)
- Icons on section titles in the sidebar

[1.20.0]: https://github.com/dfreerksen/saeng/releases/tag/v1.20.0
